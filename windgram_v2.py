...
# -*- coding: utf-8 -*-
"""
windgram_v2.py -- entry-point (lanciatore) della dashboard windgram.

Orchestrazione della pipeline a strati (REFACTOR.md): sorgenti dati
(windgram.sources) -> fisica (windgram.core) -> contratto (windgram.contract) ->
renderer (windgram.render). Interroga Open-Meteo/ICON-D2, assembla il contratto
`Forecast`, ne scrive il log storico (F2) e lo passa al renderer SVG che produce
il file .html.
