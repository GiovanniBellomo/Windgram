...
# -*- coding: utf-8 -*-
"""
windgram.render.svg -- Strato 2: renderer dashboard HTML+SVG.

Consuma SOLO il contratto `windgram.contract.Forecast` (nessuna fisica, nessun
I/O di rete): produce l'SVG completo della dashboard (header, colonna sintesi,
grafico, legende, tabella oraria, footer). `build_svg(forecast)` e' l'entry-point;
`build_chart` disegna il corpo del grafico. Estratto da windgram_v2.py in Fase G1.

Gli array numpy sciolti che il codice di disegno usa si RICOSTRUISCONO dal
contratto in testa a build_svg/build_chart (helper `_narr`, None->NaN), cosi' il
renderer resta puro consumatore del contratto (REFACTOR.md, E3d/G1).
"""
...
import numpy as np
from windgram.core.thermals import make_vscale
from windgram.core.aggregate import _card16
...
# =========================================================================== #
# AGGREGAZIONI: `aggregate`, `_best_block`, `_card16` spostati in
# windgram/core/aggregate.py (REFACTOR.md, C3) e importati in cima.
# =========================================================================== #
